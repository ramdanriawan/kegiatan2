				...
				<tbody>
					<tr>
						...
						<td>
						  ...
						  <a href="?menu=user_edit&aksi=hapus&nmr=<?php echo $us['kd_user']; ?>" class="btn btn-xs btn-danger tipsy-kiri-atas" title="Hapus Data Ini" onclick="return confirm('ANDA YAKIN AKAN MENGHAPUS DATA PENTING INI ... ?')"><i class="icon-edit icon-white"></i></a>
						  </div>
						</td>
					</tr>
				</tbody>
