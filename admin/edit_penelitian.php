...
if(isset($_POST['submit']) == "Update"){
	...
	$query = "update penelitian set jdl_kegiatan = '$jdl_kegiatan', target_wkt_capai = '$tanggalawal _ $tanggalakhir', target_capai = '$target_capai',
	...
	if ($result){ 
		echo "<script>alert('Update berhasil!'); document.location = '?menu=penelitian'</script>";	
	} else {
		echo "<script>alert('Update gagal !'); document.location = '?menu=penelitian'</script>";	
	}
}
